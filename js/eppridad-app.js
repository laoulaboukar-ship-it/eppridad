...
async function afficherCertificat(){
  ...
  const fabricPattern = `<defs><pattern id="ecxFab" width="8" height="4" patternUnits="userSpaceOnUse"><rect width="8" height="4" fill="#0F2818"/><polygon points="4,0 8,2 4,4 0,2" fill="#C9A84C"/><polygon points="4,1 6,2 4,3 2,2" fill="#8c1c1c"/></pattern></defs><rect width="100" height="4" fill="url(#ecxFab)"/>`;
  const wreathSvg = `<svg class="ecx-wreath" viewBox="0 0 170 104"><g fill="none" stroke="#C9A84C" stroke-width="2.2"><path d="M78 98 C 45 96, 20 78, 16 50 C 15 38, 17 28, 22 20" stroke-linecap="round"/><path d="M92 98 C 125 96, 150 78, 154 50 C 155 38, 153 28, 148 20" stroke-linecap="round"/></g><g fill="#C9A84C"><path d="M22 20 q 9 -2 10 6 q -9 3 -10 -6 Z" transform="rotate(10 22 20)"/><path d="M17 30 q 9 -3 11 5 q -9 4 -11 -5 Z" transform="rotate(2 17 30)"/><path d="M15 41 q 9.5 -1.5 10.5 6.5 q -9.5 3 -10.5 -6.5 Z" transform="rotate(-6 15 41)"/><path d="M17 52 q 9.5 -0.5 9.5 7.5 q -9.5 2 -9.5 -7.5 Z" transform="rotate(-16 17 52)"/><path d="M22 63 q 10 0 8.5 8 q -9.8 1.5 -8.5 -8 Z" transform="rotate(-28 22 63)"/><path d="M30 74 q 10 1.5 7 9 q -9.5 0 -7 -9 Z" transform="rotate(-40 30 74)"/><path d="M42 84 q 10 3 5.5 9.5 q -9 -1.5 -5.5 -9.5 Z" transform="rotate(-55 42 84)"/><path d="M58 92 q 9.5 4.5 3.5 10 q -8.5 -3 -3.5 -10 Z" transform="rotate(-68 58 92)"/><path d="M148 20 q -9 -2 -10 6 q 9 3 10 -6 Z" transform="rotate(-10 148 20)"/><path d="M153 30 q -9 -3 -11 5 q 9 4 11 -5 Z" transform="rotate(-2 153 30)"/><path d="M155 41 q -9.5 -1.5 -10.5 6.5 q 9.5 3 10.5 -6.5 Z" transform="rotate(6 155 41)"/><path d="M153 52 q -9.5 -0.5 -9.5 7.5 q 9.5 2 9.5 -7.5 Z" transform="rotate(16 153 52)"/><path d="M148 63 q -10 0 -8.5 8 q 9.8 1.5 8.5 -8 Z" transform="rotate(28 148 63)"/><path d="M140 74 q -10 1.5 -7 9 q 9.5 0 7 -9 Z" transform="rotate(40 140 74)"/><path d="M128 84 q -10 3 -5.5 9.5 q 9 -1.5 5.5 -9.5 Z" transform="rotate(55 128 84)"/><path d="M112 92 q -9.5 4.5 -3.5 10 q 8.5 -3 3.5 -10 Z" transform="rotate(68 112 92)"/></g><path d="M85 8 L 88 16 L 82 16 Z" fill="#0F2818"/></svg>`;

  container.innerHTML = `
  <div style="padding:24px 0">
    <style>
      .ecx-wrap{max-width:760px;margin:0 auto;font-family:Georgia,'Times New Roman',serif}
      .ecx-outer{background:#0F2818;border-radius:6px;box-shadow:0 24px 64px rgba(0,0,0,.45);overflow:hidden}
      .ecx-fabric{height:12px;width:100%;display:block}
      .ecx-frame{background:linear-gradient(160deg,#faf6ec,#f3ecd9);padding:14px}
      .ecx-border1{border:1.5px solid #0F2818;border-radius:2px;padding:5px}
      .ecx-border2{border:1px solid #C9A84C;border-radius:2px;padding:24px 30px 20px;position:relative;overflow:hidden}
      .ecx-corner{position:absolute;width:26px;height:26px;pointer-events:none}
      .ecx-corner.tl{top:6px;left:6px;border-top:2px solid #0F2818;border-left:2px solid #0F2818}
      .ecx-corner.tr{top:6px;right:6px;border-top:2px solid #0F2818;border-right:2px solid #0F2818}
      .ecx-corner.bl{bottom:6px;left:6px;border-bottom:2px solid #0F2818;border-left:2px solid #0F2818}
      .ecx-corner.br{bottom:6px;right:6px;border-bottom:2px solid #0F2818;border-right:2px solid #0F2818}
      .ecx-emblem-wrap{display:flex;justify-content:center;margin-bottom:2px;position:relative;z-index:1;height:74px}
      .ecx-wreath{position:absolute;top:0;left:50%;transform:translateX(-50%);width:124px;height:74px}
      .ecx-badge{position:absolute;top:9px;left:50%;transform:translateX(-50%);width:52px;height:52px;border-radius:50%;background:#fff;border:2px solid #0F2818;overflow:hidden;display:flex;align-items:center;justify-content:center}
      .ecx-badge img{width:100%;height:100%;object-fit:cover}
      .ecx-badge span{display:none;font-family:'Playfair Display',serif;font-size:8px;font-weight:700;color:#0F2818;text-align:center}
      .ecx-brand{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:24px;font-weight:900;color:#0F2818;letter-spacing:1px;margin-bottom:2px;position:relative;z-index:1}
      .ecx-brand-sub{text-align:center;font-size:9.5px;font-weight:700;color:#0F2818;letter-spacing:1.3px;line-height:1.5;margin-bottom:10px;position:relative;z-index:1}
      .ecx-divider{display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:9px;position:relative;z-index:1}
      .ecx-divider .l{height:1px;background:#C9A84C;width:80px}
      .ecx-divider .leaf{font-size:11px}
      .ecx-tag{text-align:center;font-family:Arial,sans-serif;font-size:9.5px;font-weight:700;letter-spacing:1.6px;color:#0F2818;margin-bottom:7px;position:relative;z-index:1}
      .ecx-title{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:42px;font-weight:900;color:#0F2818;letter-spacing:2px;line-height:1;margin-bottom:2px;position:relative;z-index:1}
      .ecx-title2{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:16px;font-weight:700;color:#0F2818;letter-spacing:4px;margin-bottom:9px;position:relative;z-index:1}
      .ecx-lbl{text-align:center;font-family:Georgia,serif;font-size:11.5px;color:#555;margin-bottom:5px;position:relative;z-index:1}
      .ecx-name{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:25px;font-weight:800;color:#0F2818;letter-spacing:.5px;margin-bottom:7px;text-transform:uppercase;word-break:break-word;position:relative;z-index:1}
      .ecx-form{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:16.5px;font-weight:800;color:#0F2818;letter-spacing:.5px;margin-bottom:6px;text-transform:uppercase;position:relative;z-index:1}
      .ecx-mention{text-align:center;font-family:Arial,sans-serif;font-size:10.5px;color:#9a7b1f;font-weight:700;letter-spacing:.5px;margin-bottom:16px;position:relative;z-index:1}
      .ecx-footer-row{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:10px;position:relative;z-index:1}
      .ecx-loc{font-family:Georgia,serif;font-size:11.5px;color:#1a1a1a}
      .ecx-loc b{display:block;font-size:11.5px}
      .ecx-loc .date{font-size:10.5px;color:#333;margin-top:1px}
      .ecx-sign{text-align:center}
      .ecx-stampsig{width:100px;height:auto;display:block;margin:0 auto 1px}
      .ecx-sign-title{font-size:9px;color:#555;font-family:Arial,sans-serif}
      .ecx-sign-title b{color:#222}
      .ecx-bline{height:1px;background:rgba(15,40,24,.15);margin-bottom:9px}
      .ecx-verify-row{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:9px;position:relative;z-index:1}
      .ecx-qr-zone{display:flex;align-items:center;gap:10px}
      .ecx-qr-zone img{width:46px;height:46px;border:1px solid rgba(15,40,24,.15);border-radius:4px;background:#fff;padding:2px}
      .ecx-qr-txt{font-family:Arial,sans-serif;font-size:9px;color:#555}
      .ecx-qr-txt b{color:#0F2818;display:block;font-size:9.5px}
      .ecx-certnum{font-family:Arial,sans-serif;font-size:9.5px;color:#555}
      .ecx-mline{height:1px;background:#C9A84C;width:200px;margin:0 auto 6px}
      .ecx-motto{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:12px;font-weight:700;color:#0F2818;letter-spacing:1px;margin-bottom:5px;position:relative;z-index:1}
      .ecx-tagline{text-align:center;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:#C9A84C;letter-spacing:1.5px;position:relative;z-index:1}
    </style>
    <div class="ecx-wrap">
      <div class="ecx-outer">
        <svg class="ecx-fabric" viewBox="0 0 100 4" preserveAspectRatio="none">${fabricPattern}</svg>
        <div class="ecx-frame">
          <div class="ecx-border1">
            <div class="ecx-border2">
              <div class="ecx-corner tl"></div>
              <div class="ecx-corner tr"></div>
              <div class="ecx-corner bl"></div>
              <div class="ecx-corner br"></div>

              <div class="ecx-emblem-wrap">
                ${wreathSvg}
                <div class="ecx-badge">
              ...
              <div class="ecx-brand">EPPRIDAD</div>
              <div class="ecx-brand-sub">ÉCOLE POLYTECHNIQUE PRIVÉE POUR LE<br>DÉVELOPPEMENT AGRICOLE DURABLE</div>

              <div class="ecx-divider"><div class="l"></div><div class="leaf">🌿</div><div class="l"></div></div>
              <div class="ecx-tag">FORMATION EN LIGNE · CERTIFICAT PROFESSIONNEL</div>
              <div class="ecx-title">CERTIFICAT</div>
              <div class="ecx-title2">DE FORMATION</div>
              <div class="ecx-divider"><div class="l"></div><div class="leaf">🌿</div><div class="l"></div></div>

              <div class="ecx-lbl">Ce certificat est décerné à</div>
              <div class="ecx-name">${escH(nomAffiche)}</div>
              <div class="ecx-lbl">pour avoir suivi et achevé avec succès la formation</div>
              <div class="ecx-form">${escH(formTitre)}</div>
              <div class="ecx-mention">🏆 Mention ${escH(cert.mention||'Bien')} · Score ${cert.score_final||0}%</div>

              <div class="ecx-footer-row">
                <div class="ecx-loc">
                  <b>📍 Fait à Niamey, Niger</b>
                ...
                <div class="ecx-sign">
                  ...
                  <div class="ecx-sign-title"><b>Boukar Laoula</b><br>Directeur Général &amp; Fondateur</div>
                </div>
              </div>

              <div class="ecx-bline"></div>
              <div class="ecx-verify-row">
                <div class="ecx-qr-zone">
                  <img src="${qrUrl}" alt="QR vérification" onerror="this.style.display='none'">
                  <div class="ecx-qr-txt"><b>Vérifiez l'authenticité sur</b>www.eppridad.com/verifier.html</div>
                </div>
                <div class="ecx-certnum">N° de certificat : <b>${escH(cert.numero||'—')}</b></div>
              </div>

              <div class="ecx-mline"></div>
              <div class="ecx-motto">FORMER LES BÂTISSEURS DU MONDE RURAL</div>
              <div class="ecx-tagline">EXCELLENCE · DISCIPLINE · INNOVATION · ENGAGEMENT</div>
            </div>
          </div>
        </div>
        <svg class="ecx-fabric" viewBox="0 0 100 4" preserveAspectRatio="none">${fabricPattern}</svg>
...
function imprimerCertificat(num,nom,form,mention,score,date){
  ...
  const fabricPattern = `<defs><pattern id="pcxFab" width="8" height="4" patternUnits="userSpaceOnUse"><rect width="8" height="4" fill="#0F2818"/><polygon points="4,0 8,2 4,4 0,2" fill="#C9A84C"/><polygon points="4,1 6,2 4,3 2,2" fill="#8c1c1c"/></pattern></defs><rect width="100" height="4" fill="url(#pcxFab)"/>`;
  const wreathSvg = `<svg class="pcx-wreath" viewBox="0 0 170 104"><g fill="none" stroke="#C9A84C" stroke-width="2.2"><path d="M78 98 C 45 96, 20 78, 16 50 C 15 38, 17 28, 22 20" stroke-linecap="round"/><path d="M92 98 C 125 96, 150 78, 154 50 C 155 38, 153 28, 148 20" stroke-linecap="round"/></g><g fill="#C9A84C"><path d="M22 20 q 9 -2 10 6 q -9 3 -10 -6 Z" transform="rotate(10 22 20)"/><path d="M17 30 q 9 -3 11 5 q -9 4 -11 -5 Z" transform="rotate(2 17 30)"/><path d="M15 41 q 9.5 -1.5 10.5 6.5 q -9.5 3 -10.5 -6.5 Z" transform="rotate(-6 15 41)"/><path d="M17 52 q 9.5 -0.5 9.5 7.5 q -9.5 2 -9.5 -7.5 Z" transform="rotate(-16 17 52)"/><path d="M22 63 q 10 0 8.5 8 q -9.8 1.5 -8.5 -8 Z" transform="rotate(-28 22 63)"/><path d="M30 74 q 10 1.5 7 9 q -9.5 0 -7 -9 Z" transform="rotate(-40 30 74)"/><path d="M42 84 q 10 3 5.5 9.5 q -9 -1.5 -5.5 -9.5 Z" transform="rotate(-55 42 84)"/><path d="M58 92 q 9.5 4.5 3.5 10 q -8.5 -3 -3.5 -10 Z" transform="rotate(-68 58 92)"/><path d="M148 20 q -9 -2 -10 6 q 9 3 10 -6 Z" transform="rotate(-10 148 20)"/><path d="M153 30 q -9 -3 -11 5 q 9 4 11 -5 Z" transform="rotate(-2 153 30)"/><path d="M155 41 q -9.5 -1.5 -10.5 6.5 q 9.5 3 10.5 -6.5 Z" transform="rotate(6 155 41)"/><path d="M153 52 q -9.5 -0.5 -9.5 7.5 q 9.5 2 9.5 -7.5 Z" transform="rotate(16 153 52)"/><path d="M148 63 q -10 0 -8.5 8 q 9.8 1.5 8.5 -8 Z" transform="rotate(28 148 63)"/><path d="M140 74 q -10 1.5 -7 9 q 9.5 0 7 -9 Z" transform="rotate(40 140 74)"/><path d="M128 84 q -10 3 -5.5 9.5 q 9 -1.5 5.5 -9.5 Z" transform="rotate(55 128 84)"/><path d="M112 92 q -9.5 4.5 -3.5 10 q 8.5 -3 3.5 -10 Z" transform="rotate(68 112 92)"/></g><path d="M85 8 L 88 16 L 82 16 Z" fill="#0F2818"/></svg>`;
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    body{background:#e9e4d8;font-family:Georgia,'Times New Roman',serif;padding:26px;display:flex;justify-content:center}
    ...
    .pcx-outer{background:#0F2818;border-radius:6px;box-shadow:0 30px 80px rgba(0,0,0,.35);overflow:hidden}
    .pcx-fabric{height:12px;width:100%;display:block}
    .pcx-frame{background:linear-gradient(160deg,#faf6ec,#f3ecd9);padding:14px}
    .pcx-border1{border:1.5px solid #0F2818;border-radius:2px;padding:5px}
    .pcx-border2{border:1px solid #C9A84C;border-radius:2px;padding:20px 46px 16px;position:relative;overflow:hidden;min-height:400px}
    .pcx-corner{position:absolute;width:28px;height:28px;pointer-events:none}
    .pcx-corner.tl{top:5px;left:5px;border-top:2px solid #0F2818;border-left:2px solid #0F2818}
    .pcx-corner.tr{top:5px;right:5px;border-top:2px solid #0F2818;border-right:2px solid #0F2818}
    .pcx-corner.bl{bottom:5px;left:5px;border-bottom:2px solid #0F2818;border-left:2px solid #0F2818}
    .pcx-corner.br{bottom:5px;right:5px;border-bottom:2px solid #0F2818;border-right:2px solid #0F2818}
    .pcx-emblem-wrap{display:flex;justify-content:center;margin-bottom:2px;position:relative;z-index:1;height:66px}
    .pcx-wreath{position:absolute;top:0;left:50%;transform:translateX(-50%);width:110px;height:66px}
    .pcx-badge{position:absolute;top:8px;left:50%;transform:translateX(-50%);width:46px;height:46px;border-radius:50%;background:#fff;border:2px solid #0F2818;overflow:hidden;display:flex;align-items:center;justify-content:center}
    .pcx-badge img{width:100%;height:100%;object-fit:cover}
    .pcx-badge span{display:none;font-family:'Playfair Display',serif;font-size:7px;font-weight:700;color:#0F2818;text-align:center}
    .pcx-brand{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:22px;font-weight:900;color:#0F2818;letter-spacing:1px;margin-bottom:2px;position:relative;z-index:1}
    .pcx-brand-sub{text-align:center;font-size:9px;font-weight:700;color:#0F2818;letter-spacing:1.2px;line-height:1.4;margin-bottom:8px;position:relative;z-index:1}
    .pcx-divider{display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:8px;position:relative;z-index:1}
    .pcx-divider .l{height:1px;background:#C9A84C;width:90px}
    .pcx-divider .leaf{font-size:10px}
    .pcx-tag{text-align:center;font-family:Arial,sans-serif;font-size:9px;font-weight:700;letter-spacing:1.5px;color:#0F2818;margin-bottom:6px;position:relative;z-index:1}
    .pcx-title{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:38px;font-weight:900;color:#0F2818;letter-spacing:2px;line-height:1;margin-bottom:1px;position:relative;z-index:1}
    .pcx-title2{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:15px;font-weight:700;color:#0F2818;letter-spacing:4px;margin-bottom:8px;position:relative;z-index:1}
    .pcx-lbl{text-align:center;font-family:Georgia,serif;font-size:11px;color:#555;margin-bottom:4px;position:relative;z-index:1}
    .pcx-name{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:24px;font-weight:800;color:#0F2818;letter-spacing:.5px;margin-bottom:6px;text-transform:uppercase;word-break:break-word;position:relative;z-index:1}
    .pcx-form{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:16px;font-weight:800;color:#0F2818;letter-spacing:.5px;margin-bottom:5px;text-transform:uppercase;position:relative;z-index:1}
    .pcx-mention{text-align:center;font-family:Arial,sans-serif;font-size:10px;color:#9a7b1f;font-weight:700;letter-spacing:.5px;margin-bottom:12px;position:relative;z-index:1}
    .pcx-footer-row{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin-bottom:8px;position:relative;z-index:1}
    .pcx-loc{font-family:Georgia,serif;font-size:11px;color:#1a1a1a}
    .pcx-loc b{display:block;font-size:11px}
    .pcx-loc .date{font-size:10.5px;color:#333;margin-top:1px}
    .pcx-sign{text-align:center}
    .pcx-stampsig{width:98px;height:auto;display:block;margin:0 auto 1px}
    .pcx-sign-title{font-size:9px;color:#555;font-family:Arial,sans-serif}
    .pcx-sign-title b{color:#222}
    .pcx-bline{height:1px;background:rgba(15,40,24,.15);margin-bottom:8px}
    .pcx-verify-row{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:8px;position:relative;z-index:1}
    .pcx-qr-zone{display:flex;align-items:center;gap:10px}
    .pcx-qr-zone img{width:42px;height:42px;border:1px solid rgba(15,40,24,.15);border-radius:4px;background:#fff;padding:2px}
    .pcx-qr-txt{font-family:Arial,sans-serif;font-size:9px;color:#555}
    .pcx-qr-txt b{color:#0F2818;display:block;font-size:9.5px}
    .pcx-certnum{font-family:Arial,sans-serif;font-size:9.5px;color:#555}
    .pcx-mline{height:1px;background:#C9A84C;width:220px;margin:0 auto 5px}
    .pcx-motto{text-align:center;font-family:'Playfair Display',Georgia,serif;font-size:11px;font-weight:700;color:#0F2818;letter-spacing:1px;margin-bottom:4px;position:relative;z-index:1}
    .pcx-tagline{text-align:center;font-family:Arial,sans-serif;font-size:8.5px;font-weight:700;color:#C9A84C;letter-spacing:1.5px;position:relative;z-index:1}
  </style></head><body>
  <div class="pcx-wrap">
    ...
    <div class="pcx-outer">
      <svg class="pcx-fabric" viewBox="0 0 100 4" preserveAspectRatio="none">${fabricPattern}</svg>
      <div class="pcx-frame">
        <div class="pcx-border1">
          <div class="pcx-border2">
            <div class="pcx-corner tl"></div>
            <div class="pcx-corner tr"></div>
            <div class="pcx-corner bl"></div>
            <div class="pcx-corner br"></div>

            <div class="pcx-emblem-wrap">
              ${wreathSvg}
              <div class="pcx-badge">
                <img src="https://www.eppridad.com/logo.png" alt="EPPRIDAD" crossorigin="anonymous" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                <span>EPPRIDAD</span>
              </div>
            </div>
            <div class="pcx-brand">EPPRIDAD</div>
            <div class="pcx-brand-sub">ÉCOLE POLYTECHNIQUE PRIVÉE POUR LE DÉVELOPPEMENT AGRICOLE DURABLE</div>

            <div class="pcx-divider"><div class="l"></div><div class="leaf">🌿</div><div class="l"></div></div>
            <div class="pcx-tag">FORMATION EN LIGNE · CERTIFICAT PROFESSIONNEL</div>
            <div class="pcx-title">CERTIFICAT</div>
            <div class="pcx-title2">DE FORMATION</div>
            <div class="pcx-divider"><div class="l"></div><div class="leaf">🌿</div><div class="l"></div></div>

            <div class="pcx-lbl">Ce certificat est décerné à</div>
            <div class="pcx-name">${nom}</div>
            <div class="pcx-lbl">pour avoir suivi et achevé avec succès la formation</div>
            <div class="pcx-form">${form}</div>
            <div class="pcx-mention">🏆 Mention ${mention} · Score ${score}%</div>

            <div class="pcx-footer-row">
              <div class="pcx-loc">
                <b>📍 Fait à Niamey, Niger</b>
              ...
              <div class="pcx-sign">
                ...
                <div class="pcx-sign-title"><b>Boukar Laoula</b><br>Directeur Général &amp; Fondateur</div>
              </div>
            </div>

            <div class="pcx-bline"></div>
            <div class="pcx-verify-row">
              <div class="pcx-qr-zone">
                <img src="${qrUrl}" alt="QR vérification" crossorigin="anonymous">
                <div class="pcx-qr-txt"><b>Vérifiez l'authenticité sur</b>www.eppridad.com/verifier.html</div>
              </div>
              <div class="pcx-certnum">N° de certificat : <b>${num}</b></div>
            </div>

            <div class="pcx-mline"></div>
            <div class="pcx-motto">FORMER LES BÂTISSEURS DU MONDE RURAL</div>
            <div class="pcx-tagline">EXCELLENCE · DISCIPLINE · INNOVATION · ENGAGEMENT</div>
          </div>
        </div>
      </div>
      <svg class="pcx-fabric" viewBox="0 0 100 4" preserveAspectRatio="none">${fabricPattern}</svg>
...
// ── SURCHARGE loadStudentDashboard ───────────────────────────
// Neutralise la version legacy de espace-etudiant.js qui cherche
// des éléments HTML (#dashboardError) qui n'existent plus
async function loadStudentDashboard(matricule){
  // Déléguer à notre loadEtudDashboard qui gère correctement
  if(typeof loadEtudDashboard === 'function') await loadEtudDashboard();
}
...
async function loadNotes(){
  ...
  const parAnnee = {};
  notes.forEach(n=>{ const a=n.annee_scolaire||'—'; if(!parAnnee[a]) parAnnee[a]=[]; parAnnee[a].push(n); });
  el.innerHTML = Object.keys(parAnnee).sort((a,b)=>b.localeCompare(a)).map(annee=>{
    const lg = parAnnee[annee];
    const moyAnn = lg.find(n=>n.type_eval==='moyenne_annuelle'||n.semestre==='Annuel');
    const moyS1  = lg.find(n=>n.semestre==='S1'&&(n.type_eval==='moyenne'||n.matiere==='Moyenne S1'));
    const moyS2  = lg.find(n=>n.semestre==='S2'&&(n.type_eval==='moyenne'||n.matiere==='Moyenne S2'));
    const details= lg.filter(n=>n.matiere!=='Moyenne S1'&&n.matiere!=='Moyenne S2'&&n.matiere!=='Moyenne annuelle'&&n.type_eval!=='moyenne_annuelle'&&n.type_eval!=='moyenne');
    const moy=parseFloat(moyAnn?.note||0);
    const col=moy>=14?'#ffd700':moy>=12?'#81c784':moy>=10?'#ffb74d':'#ef9a9a';
    const men=moy>=16?'Très Bien':moy>=14?'Bien':moy>=12?'Assez Bien':moy>=10?'Passable':'Ajourné';
    return '<div style="margin-bottom:28px">'
      +'<div style="font-family:\'Playfair Display\',serif;font-size:18px;font-weight:700;color:var(--w);margin-bottom:12px;display:flex;align-items:center;gap:10px;flex-wrap:wrap">'
      +'📅 Année '+escH(annee)
      +(moyAnn?'<span style="font-size:13px;font-weight:700;padding:3px 12px;border-radius:20px;background:rgba(255,255,255,.08);color:'+col+'">'+parseFloat(moyAnn.note).toFixed(2)+'/20 — '+men+'</span>':'')
      +'</div>'
      +((moyS1||moyS2)?'<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:14px">'
        +(moyS1?'<div style="background:rgba(255,255,255,.05);border-radius:10px;padding:14px;text-align:center"><div style="font-size:11px;color:var(--w3);margin-bottom:4px;text-transform:uppercase;letter-spacing:.5px">Semestre 1</div><div style="font-size:24px;font-weight:800;color:'+(parseFloat(moyS1.note)>=10?'#81c784':'#ef9a9a')+'">'+parseFloat(moyS1.note).toFixed(2)+'<span style="font-size:13px;color:var(--w3)">/20</span></div></div>':'')
        +(moyS2?'<div style="background:rgba(255,255,255,.05);border-radius:10px;padding:14px;text-align:center"><div style="font-size:11px;color:var(--w3);margin-bottom:4px;text-transform:uppercase;letter-spacing:.5px">Semestre 2</div><div style="font-size:24px;font-weight:800;color:'+(parseFloat(moyS2.note)>=10?'#81c784':'#ef9a9a')+'">'+parseFloat(moyS2.note).toFixed(2)+'<span style="font-size:13px;color:var(--w3)">/20</span></div></div>':'')
        +'</div>':'')
      +(details.length?'<div style="font-size:11px;color:var(--w3);text-transform:uppercase;letter-spacing:.8px;font-weight:700;margin-bottom:8px">Notes par matière</div>'
        +'<div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);border-radius:12px;overflow:hidden">'
        +'<table style="width:100%;border-collapse:collapse;font-size:13px">'
        +'<thead><tr style="background:rgba(255,255,255,.06)"><th style="padding:9px 14px;text-align:left;color:var(--or);font-size:11px;font-weight:700">Matière</th><th style="padding:9px 14px;text-align:center;color:var(--or);font-size:11px;font-weight:700">Sem.</th><th style="padding:9px 14px;text-align:right;color:var(--or);font-size:11px;font-weight:700">Note</th></tr></thead>'
        +'<tbody>'+details.sort((a,b)=>(a.semestre||'').localeCompare(b.semestre||'')).map((n,i)=>{
          const nt=parseFloat(n.note); const nc=nt>=14?'#ffd700':nt>=12?'#81c784':nt>=10?'#ffb74d':'#ef9a9a';
          return '<tr style="border-top:1px solid rgba(255,255,255,.05);background:'+(i%2?'rgba(255,255,255,.02)':'')+'"><td style="padding:9px 14px;color:var(--w)">'+escH(n.matiere)+'</td><td style="padding:9px 14px;text-align:center;color:var(--w3)">'+escH(n.semestre||'—')+'</td><td style="padding:9px 14px;text-align:right;font-weight:800;color:'+nc+'">'+nt.toFixed(2)+'</td></tr>';
...
async function loadScolarite(){
  ...
  const paie=window._sessionData?.paiements||[];
  if(!rows.length){
  ...
  el.innerHTML='<div style="margin-bottom:20px"><div style="font-family:\'Playfair Display\',serif;font-size:22px;font-weight:700;color:var(--w);margin-bottom:4px">💳 Ma scolarité</div><div style="font-size:13px;color:var(--w3)">Situation financière et historique des versements</div></div>'
    +rows.map(r=>{
      const nette=parseFloat(r.nette||0),verse=parseFloat(r.verse||0),solde=parseFloat(r.solde||0);
      const pct=nette>0?Math.min(100,Math.round(verse/nette*100)):100;
      const stColor=solde<=0?'#81c784':solde<50000?'#ffb74d':'#ef9a9a';
      const stLabel={'solde':'✅ Soldé','solde_bourse':'🎓 Bourse','abandon':'⛔ Abandon','a_relancer':'⚠️ À régulariser','en_cours':'🔄 En cours'}[r.statut]||'🔄 En cours';
      const pa=paie.filter(p=>p.annee_scolaire===r.annee).sort((a,b)=>new Date(a.periode)-new Date(b.periode));
      return '<div style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:16px;padding:20px;margin-bottom:16px">'
        +'<div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;margin-bottom:16px"><div style="font-family:\'Playfair Display\',serif;font-size:17px;font-weight:700;color:var(--w)">📅 '+escH(r.annee||'—')+'</div><span style="font-size:12px;font-weight:700;padding:4px 14px;border-radius:20px;background:rgba(255,255,255,.08);color:'+stColor+'">'+stLabel+'</span></div>'
        +'<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:14px">'
          +'<div style="background:rgba(255,255,255,.05);border-radius:10px;padding:12px;text-align:center"><div style="font-size:10px;color:var(--w3);margin-bottom:4px">Montant net</div><div style="font-size:15px;font-weight:800;color:var(--w)">'+fmt(nette)+' F</div></div>'
          +'<div style="background:rgba(255,255,255,.05);border-radius:10px;padding:12px;text-align:center"><div style="font-size:10px;color:var(--w3);margin-bottom:4px">Total versé</div><div style="font-size:15px;font-weight:800;color:#81c784">'+fmt(verse)+' F</div></div>'
          +'<div style="background:rgba(255,255,255,.05);border-radius:10px;padding:12px;text-align:center"><div style="font-size:10px;color:var(--w3);margin-bottom:4px">Solde</div><div style="font-size:15px;font-weight:800;color:'+stColor+'">'+fmt(Math.max(0,solde))+' F</div></div>'
        +'</div>'
        +'<div style="height:8px;background:rgba(255,255,255,.1);border-radius:4px;overflow:hidden;margin-bottom:4px"><div style="height:100%;width:'+pct+'%;background:'+(pct>=100?'#81c784':pct>=50?'#ffb74d':'#ef9a9a')+';border-radius:4px"></div></div>'
        +'<div style="font-size:11px;color:var(--w3);text-align:right;margin-bottom:'+(pa.length?'16px':'0')+'">'+pct+'% réglé</div>'
        +(pa.length?'<div style="font-size:11px;color:var(--w3);text-transform:uppercase;letter-spacing:.8px;font-weight:700;margin-bottom:8px">📋 Historique des versements</div>'
          +'<div style="background:rgba(0,0,0,.2);border-radius:10px;overflow:hidden">'
          +'<table style="width:100%;border-collapse:collapse;font-size:12px">'
          +'<thead><tr style="background:rgba(255,255,255,.06)"><th style="padding:8px 12px;text-align:left;color:var(--or);font-size:10px;font-weight:700">Date</th><th style="padding:8px 12px;text-align:left;color:var(--or);font-size:10px;font-weight:700">N° Reçu</th><th style="padding:8px 12px;text-align:left;color:var(--or);font-size:10px;font-weight:700">Mode</th><th style="padding:8px 12px;text-align:right;color:var(--or);font-size:10px;font-weight:700">Montant</th></tr></thead>'
          +'<tbody>'+pa.map((p,i)=>{
            const d=p.periode?new Date(p.periode).toLocaleDateString('fr-FR',{day:'2-digit',month:'short',year:'numeric'}):'—';
            return '<tr style="border-top:1px solid rgba(255,255,255,.05);background:'+(i%2?'rgba(255,255,255,.02)':'')+'"><td style="padding:8px 12px;color:var(--w2)">'+d+'</td><td style="padding:8px 12px;font-family:monospace;color:var(--or);font-size:11px">#'+escH(p.reference||'—')+'</td><td style="padding:8px 12px;color:var(--w3)">'+escH(p.mode_paiement||'Espèces')+'</td><td style="padding:8px 12px;text-align:right;font-weight:800;color:#81c784">'+fmt(p.montant)+' F</td></tr>';
          }).join('')
          +'<tr style="border-top:2px solid rgba(255,255,255,.12);background:rgba(255,255,255,.04)"><td colspan="3" style="padding:8px 12px;font-weight:700;color:var(--w)">Total</td><td style="padding:8px 12px;text-align:right;font-weight:800;color:#81c784;font-size:14px">'+fmt(pa.reduce((s,p)=>s+parseFloat(p.montant||0),0))+' F</td></tr>'
          +'</tbody></table></div>':'')
        +'</div>';
    }).join('');
}
...
async function loadDocs(){
  ...
  el.innerHTML='<div style="margin-bottom:20px"><div style="font-family:\'Playfair Display\',serif;font-size:22px;font-weight:700;color:var(--w)">📚 Documents</div><div style="font-size:13px;color:var(--w3);margin-top:4px">Documents mis à disposition par l\'administration</div></div>'
    + docs.map(d=>{
      const ico={'emploi_temps':'📅','bulletin':'📊','annonce':'📢','cours':'📖','autre':'📄'}[d.type]||'📄';
      return '<div style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:14px;padding:16px;margin-bottom:10px;display:flex;align-items:center;gap:14px">'
        +'<div style="font-size:28px;flex-shrink:0">'+ico+'</div>'
        +'<div style="flex:1;min-width:0">'
        +'<div style="font-size:14px;font-weight:700;color:var(--w);margin-bottom:2px">'+escH(d.titre)+'</div>'
        +'<div style="font-size:11px;color:var(--w3)">'+escH(d.type||'Document')+(d.filiere?' · '+escH(d.filiere):'')+'</div>'
        +'</div>'
        +(d.url?'<a href="'+escH(d.url)+'" target="_blank" style="background:rgba(201,168,76,.15);color:var(--or);border:1px solid rgba(201,168,76,.3);border-radius:9px;padding:7px 14px;font-size:12px;font-weight:700;text-decoration:none;white-space:nowrap;flex-shrink:0">⬇ Ouvrir</a>':'')
        +'</div>';
    }).join('');
}
...
// ── ENVOI IDENTIFIANTS SUR NUMÉRO ALTERNATIF ─────────────────
async function ouvrirEnvoiWhatsApp(matricule, nomComplet, telephoneOriginal, email){
  // Récupérer le mot de passe actuel depuis portail_comptes via passerelle
  let modal = document.getElementById('whatsappEnvoiModal');
  if(!modal){
    modal = document.createElement('div');
    modal.id = 'whatsappEnvoiModal';
    modal.style.cssText = 'display:none;position:fixed;inset:0;z-index:10000;background:rgba(0,0,0,.75);align-items:center;justify-content:center;padding:16px';
    document.body.appendChild(modal);
  ...
  modal.innerHTML = `
    <div style="background:#0f2818;border:1px solid rgba(37,211,102,.3);border-radius:18px;max-width:440px;width:100%;padding:0;overflow:hidden">
      <div style="background:rgba(37,211,102,.12);padding:18px 22px;border-bottom:1px solid rgba(37,211,102,.2)">
        <div style="font-family:'Playfair Display',serif;font-size:17px;font-weight:700;color:#fff">💬 Renvoyer les identifiants</div>
        <div style="font-size:12px;color:rgba(255,255,255,.5);margin-top:3px">${nomS} · ${matS}</div>
      </div>
      <div style="padding:22px">

        <div style="background:rgba(255,152,0,.08);border:1px solid rgba(255,152,0,.25);border-radius:10px;padding:12px 14px;margin-bottom:18px">
          <div style="font-size:12px;color:#ffb74d;font-weight:700;margin-bottom:4px">⚠️ Numéro enregistré : ${escH(telS||'Non renseigné')}</div>
          <div style="font-size:11px;color:rgba(255,255,255,.45)">Si ce numéro ne fonctionne pas, saisissez le bon numéro ci-dessous.</div>
        </div>
        ...
        <div style="margin-bottom:18px">
          <label style="font-size:11px;color:rgba(255,255,255,.5);font-weight:700;text-transform:uppercase;letter-spacing:.8px;display:block;margin-bottom:6px">Message à envoyer</label>
          <textarea id="wa-msg-input" rows="7" style="width:100%;background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.15);border-radius:10px;padding:11px 14px;font-size:12px;color:#fff;font-family:inherit;outline:none;resize:vertical;box-sizing:border-box;line-height:1.6">Bonjour ${nomS},

Voici vos identifiants pour accéder à votre espace EPPRIDAD :

🔑 Matricule : ${matS}
🔒 Mot de passe : (voir dans Identifiants)

👉 Connectez-vous ici :
https://www.eppridad.com/espace-etudiant.html

Vous pouvez changer votre mot de passe depuis votre espace.

L'équipe EPPRIDAD 🌱
📞 +227 99 85 15 32</textarea>
        </div>

        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <button onclick="document.getElementById('whatsappEnvoiModal').style.display='none'" style="background:rgba(255,255,255,.06);color:rgba(255,255,255,.6);border:1px solid rgba(255,255,255,.12);border-radius:10px;padding:11px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit">✕ Annuler</button>
          <button onclick="envoyerWAAlternatif()" style="background:linear-gradient(135deg,#075e54,#128c7e);color:#fff;border:none;border-radius:10px;padding:11px;font-size:13px;font-weight:800;cursor:pointer;font-family:inherit">💬 Ouvrir WhatsApp</button>
        </div>

        <div style="margin-top:14px;padding-top:14px;border-top:1px solid rgba(255,255,255,.08)">
          <button onclick="openIdentifiantsModal('${safeStr(matricule)}','${safeStr(nomComplet||'')}','${safeStr(telephoneOriginal||'')}','${safeStr(email||'')}')" style="width:100%;background:rgba(33,150,243,.12);color:#64b5f6;border:1px solid rgba(33,150,243,.25);border-radius:10px;padding:10px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">
            🔑 Voir / modifier les identifiants d'abord
          </button>
        </div>
      </div>
    </div>`;
...
function envoyerWAAlternatif(){
  const tel = (document.getElementById('wa-tel-input')?.value||'').replace(/\D/g,'');
  const msg = document.getElementById('wa-msg-input')?.value||'';
  if(!tel){ alert('Veuillez saisir un numéro WhatsApp.'); return; }
        ...
        <div style="display:flex;align-items:flex-start;gap:14px;flex-wrap:wrap">
          ...
          <div style="flex:1;min-width:220px">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;flex-wrap:wrap">
              <div onclick="ouvrirFicheApprenant('${safeAttr(i.email)}','${safeAttr(i.prenom)}','${safeAttr(i.nom)}','${safeAttr(i.telephone)}','${safeAttr(i.reference)}')" style="font-size:15px;font-weight:800;color:#fff;cursor:pointer;text-decoration:underline;text-decoration-color:rgba(201,168,76,.35);text-decoration-thickness:1.5px" title="Cliquer pour voir la fiche complète de l'apprenant">${safeHtml(i.prenom)||''} ${safeHtml(i.nom)||''} 🔍</div>
          ...
          <div style="display:flex;flex-direction:column;gap:7px;flex-shrink:0;min-width:130px">
            ...
            ${i.type_inscription!=='enligne'&&i.statut!=='traite'?`
            <button onclick="updateInscriptionStatus('${safeAttr(i.id)}','traite');toast('✅ Inscription validée',3500);"
            ...
            <select onchange="updateInscriptionStatus('${safeAttr(i.id)}',this.value)"
...
// ══════════════════════════════════════════════════════════════
// FICHE COMPLÈTE APPRENANT — depuis Inscriptions
// Permet de diagnostiquer et résoudre un problème SANS toucher au code :
// voir tous les comptes liés, l'accès, la progression, les exercices,
// renvoyer/réinitialiser les identifiants, activer une nouvelle formation.
// ══════════════════════════════════════════════════════════════
async function ouvrirFicheApprenant(email, prenom, nom, telephone, reference){
  let modal = document.getElementById('ficheApprModal');
  if(!modal){
    modal = document.createElement('div');
    modal.id='ficheApprModal';
    modal.style.cssText='display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,.7);align-items:center;justify-content:center;padding:16px';
    document.body.appendChild(modal);
    modal.addEventListener('click',e=>{if(e.target===modal)modal.style.display='none';});
  }
  modal.innerHTML=`<div style="background:var(--v1,#0f2818);border:1px solid rgba(201,168,76,.25);border-radius:16px;max-width:720px;width:100%;max-height:88vh;overflow-y:auto;padding:0">
    <div style="background:rgba(255,255,255,.04);padding:18px 24px;border-bottom:1px solid rgba(255,255,255,.08);display:flex;justify-content:space-between;align-items:center;position:sticky;top:0;z-index:1">
      <div>
        <div style="font-family:'Playfair Display',serif;font-size:18px;font-weight:700;color:#fff">👤 ${escH(prenom)} ${escH(nom)}</div>
        <div style="font-size:11px;color:rgba(255,255,255,.4);margin-top:2px">Fiche complète — accès, progression, exercices</div>
      </div>
      <button onclick="document.getElementById('ficheApprModal').style.display='none'" style="background:none;border:none;color:rgba(255,255,255,.5);font-size:24px;cursor:pointer">×</button>
    </div>
    <div id="fiche-appr-body" style="padding:24px">
      <div style="text-align:center;padding:30px;color:var(--w3)">⏳ Recherche de tous les comptes liés…</div>
    </div>
  </div>`;
  modal.style.display='flex';
  ...
  try{
    ...
    const {data:inscriptionsLiees} = email
    ...
    if(!comptes.length){
      body.innerHTML = `
        <div style="background:rgba(255,152,0,.1);border:1px solid rgba(255,152,0,.3);border-radius:10px;padding:16px;margin-bottom:16px">
    ...
    if(comptes.length > 1){
      html += `<div style="background:rgba(255,152,0,.1);border:1px solid rgba(255,152,0,.3);border-radius:10px;padding:12px 16px;margin-bottom:16px;font-size:12px;color:#ffb74d">
        ⚠️ <strong>${comptes.length} comptes différents</strong> trouvés pour cette personne. C'est probablement la cause de sa difficulté à se connecter — elle a peut-être utilisé les identifiants du mauvais compte. Vérifiez ci-dessous lequel est le bon et désactivez les autres si besoin.
      </div>`;
    }

    for(const compte of comptes){
      const [{data:acces},{data:formations},{data:certs},{data:resultats},{data:soumissions}] = await Promise.all([
        db2.from('acces_formations').select('*').eq('matricule',compte.matricule),
        db2.from('formations_enligne').select('id,titre,emoji'),
        db2.from('certificats').select('*').eq('matricule',compte.matricule),
        db2.from('resultats_quiz').select('*').eq('matricule',compte.matricule),
        db2.from('soumissions_exercices').select('*').eq('matricule',compte.matricule),
      ]);
      const formMap = {}; (formations||[]).forEach(f=>{formMap[f.id]=f;});
      const isExpired = compte.expiry_date && new Date(compte.expiry_date)<new Date();

      html += `<div style="background:rgba(255,255,255,.04);border:1px solid rgba(201,168,76,.2);border-radius:14px;padding:18px;margin-bottom:16px">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:10px;flex-wrap:wrap;margin-bottom:12px">
          <div>
            <div style="font-family:monospace;font-size:15px;font-weight:800;color:var(--or)">${escH(compte.matricule)}</div>
            <div style="font-size:11px;color:rgba(255,255,255,.4);margin-top:2px">${escH(compte.email||"Pas d'email")} · Créé le ${compte.date_creation?new Date(compte.date_creation).toLocaleDateString('fr-FR'):'—'}</div>
          </div>
          <span style="font-size:11px;font-weight:700;padding:4px 10px;border-radius:20px;background:${compte.statut==='suspendu'?'rgba(229,57,53,.15)':isExpired?'rgba(255,152,0,.15)':'rgba(76,175,80,.15)'};color:${compte.statut==='suspendu'?'#ef9a9a':isExpired?'#ffb74d':'#81c784'}">${compte.statut==='suspendu'?'⏸ Suspendu':isExpired?'⛔ Expiré':'✅ Actif'}</span>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(100px,1fr));gap:8px;margin-bottom:14px">
          <div style="background:rgba(255,255,255,.04);border-radius:8px;padding:8px;text-align:center">
            <div style="font-size:18px;font-weight:700;color:#81c784">${(acces||[]).filter(a=>a.actif).length}</div>
            <div style="font-size:9px;color:rgba(255,255,255,.4)">Formations actives</div>
          </div>
          <div style="background:rgba(255,255,255,.04);border-radius:8px;padding:8px;text-align:center">
            <div style="font-size:18px;font-weight:700;color:#64b5f6">${(resultats||[]).length}</div>
            <div style="font-size:9px;color:rgba(255,255,255,.4)">Quiz passés</div>
          </div>
          <div style="background:rgba(255,255,255,.04);border-radius:8px;padding:8px;text-align:center">
            <div style="font-size:18px;font-weight:700;color:#ce93d8">${(soumissions||[]).length}</div>
            <div style="font-size:9px;color:rgba(255,255,255,.4)">Exercices soumis</div>
          </div>
          <div style="background:rgba(255,255,255,.04);border-radius:8px;padding:8px;text-align:center">
            <div style="font-size:18px;font-weight:700;color:#ffd54f">${(certs||[]).length}</div>
            <div style="font-size:9px;color:rgba(255,255,255,.4)">Certificats</div>
          </div>
        </div>

        ${(acces||[]).length?`<div style="margin-bottom:12px">
          <div style="font-size:10px;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,.35);margin-bottom:6px">Formations</div>
          ${(acces||[]).map(a=>{
            const f = formMap[a.formation_id];
            const nbQuiz = (resultats||[]).filter(r=>r.formation_id===a.formation_id).length;
            const reussis = (resultats||[]).filter(r=>r.formation_id===a.formation_id && r.reussi).length;
            return `<div style="display:flex;justify-content:space-between;align-items:center;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.05);font-size:12px">
              <span style="color:var(--w)">${escH(f?f.emoji+' '+f.titre:'Formation')}</span>
              <span style="color:rgba(255,255,255,.4)">${reussis}/${nbQuiz||0} quiz réussis · ${a.actif?'✅':'⛔'}</span>
            </div>`;
          }).join('')}
        </div>`:'<div style="font-size:12px;color:rgba(255,255,255,.3);font-style:italic;margin-bottom:12px">Aucune formation activée sur ce compte.</div>'}

        <div style="display:flex;gap:6px;flex-wrap:wrap">
          <button onclick="openIdentifiantsModal('${safeStr(compte.matricule)}','${safeStr(compte.nom_complet||'')}','${safeStr(telephone||'')}','${safeStr(compte.email||'')}')" style="background:rgba(33,150,243,.15);color:#64b5f6;border:1px solid rgba(33,150,243,.3);border-radius:8px;padding:7px 14px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">🔑 Identifiants</button>
          <button onclick="ouvrirEnvoiWhatsApp('${safeStr(compte.matricule)}','${safeStr(compte.nom_complet||prenom+' '+nom)}','${safeStr(telephone||'')}','${safeStr(compte.email||'')}')" style="background:rgba(37,211,102,.15);color:#25D366;border:1px solid rgba(37,211,102,.3);border-radius:8px;padding:7px 14px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">💬 Renvoyer sur WhatsApp</button>
          <button onclick="ouvrirGestionAcces('${safeStr(compte.matricule)}','${safeStr(compte.nom_complet||'')}')" style="background:rgba(22,80,63,.25);color:#81c784;border:1px solid rgba(76,175,80,.3);border-radius:8px;padding:7px 14px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">🎓 Gérer accès</button>
          <button onclick="ouvrirGestionCertificats('${safeStr(compte.matricule)}','${safeStr(compte.nom_complet||'')}')" style="background:rgba(201,168,76,.12);color:var(--or);border:1px solid rgba(201,168,76,.25);border-radius:8px;padding:7px 14px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">🏅 Certificats</button>
          ${compte.statut==='suspendu'
            ?`<button onclick="changerStatutApprenant('${safeStr(compte.matricule)}','actif');setTimeout(()=>ouvrirFicheApprenant('${safeStr(email||'')}','${safeStr(prenom)}','${safeStr(nom)}','${safeStr(telephone||'')}','${safeStr(reference||'')}'),800)" style="background:rgba(76,175,80,.15);color:#81c784;border:1px solid rgba(76,175,80,.3);border-radius:8px;padding:7px 14px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">▶️ Activer</button>`
            :`<button onclick="changerStatutApprenant('${safeStr(compte.matricule)}','suspendu');setTimeout(()=>ouvrirFicheApprenant('${safeStr(email||'')}','${safeStr(prenom)}','${safeStr(nom)}','${safeStr(telephone||'')}','${safeStr(reference||'')}'),800)" style="background:rgba(229,57,53,.12);color:#ef9a9a;border:1px solid rgba(229,57,53,.25);border-radius:8px;padding:7px 14px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">⏸ Suspendre</button>`}
        </div>
      </div>`;
    }

    // Inscriptions liées (historique)
    if((inscriptionsLiees||[]).length){
      html += `<div style="font-size:10px;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,.35);margin:16px 0 8px">Demandes d'inscription liées</div>`;
      (inscriptionsLiees||[]).forEach(ins=>{
        html += `<div style="font-size:11px;color:rgba(255,255,255,.45);padding:4px 0">📋 ${escH(ins.reference||'—')} · ${ins.created_at?new Date(ins.created_at).toLocaleDateString('fr-FR'):'—'} · ${escH(ins.statut||'—')}</div>`;
      });
    }
    ...
    document.getElementById('fiche-appr-body').innerHTML = `<div style="color:#ef9a9a">Erreur : ${escH(e.message)}</div>`;
  }
}

// ══════════════════════════════════════════════════════════════
// SURCHARGE — quickActiverAcces
// Corrige : pwd_hash en SHA-256 (au lieu de simpleHash legacy)
//           + vérification d'un compte existant par EMAIL avant
...
async function quickActiverAcces(reference, prenom, nom, tel, email, formation_titre){
  ...
  try{
    ...
    if(email && typeof emailAccesAccorde === 'function'){
      emailAccesAccorde(email, (prenom+' '+nom).trim(), matricule, formation_titre || 'Votre formation EPPRIDAD', pwd, null).catch(()=>{});
    } else if(email && typeof sendEmailJS !== 'undefined'){
      sendEmailJS(email, prenom+' '+nom, '🎓 Votre accès EPPRIDAD est activé',
    ...
    showLoadingOverlayV27(false);
    if(typeof showToastV27==='function') showToastV27('Erreur activation: '+err.message, '#e53935');
    else toast('❌ Erreur activation: '+err.message, 5000);
